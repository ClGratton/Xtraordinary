...
enum class MessageType(val wireValue: UByte) {
    ...
    ShowTicket(0x31u),
    ClearTicket(0x32u),
    SetRadioPolicy(0x33u),
    SetReaderPolicy(0x34u),
    BeginTicketBarcode(0x35u),
    ...
    GetReadingStats(0x43u),
    ReadingStatsChunk(0x44u),
    AckReadingStats(0x45u),
    BeginBookUpload(0x46u),
    BookUploadChunk(0x47u),
    CommitBookUpload(0x48u),
    AbortBookUpload(0x49u),
    BeginFirmware(0x50u),
    FirmwareChunk(0x51u),
