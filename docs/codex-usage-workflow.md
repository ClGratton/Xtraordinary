...
- Physical-action timing is agent-owned. Prepare and launch the bounded workflow, expose the irreducible physical gesture at the actionable control, and own bounded timing/retry; never require a chat reply merely to synchronize a physical action.
