...
- [ ] Build/install dev40, where restored-library readiness enters the same shared USB-work drain as attachment and foreground return; replay the retained 68,277-byte queue from a fresh Begin, then finish cancellation, stale-host restart, and multi-file acceptance.
