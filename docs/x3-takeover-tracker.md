...
- [ ] Build/install Android dev35: typed transport blockers must outrank **Reconnecting…**, blockers pause retry rather than spinning, and foreground pending-work recovery must cap the no-scan gap at 500 ms without making foreground visibility itself own GATT or alter X3 power policy.
