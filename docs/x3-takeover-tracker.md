...
- [ ] Capture the retained `RUNTIME_TRACE_PREVIOUS` checkpoint through the new generic USB diagnostics path, isolate the final-sync owner that stopped completing, and fix that lifecycle rather than masking the reboot.
