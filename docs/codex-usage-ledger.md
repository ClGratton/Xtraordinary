...
- Fresh real Pixel evidence: Focus screenshot/XML and slider interaction prove a nonzero 20:00 timer, Start focus, and responsive duration control; duration was restored to 20:00. Passes screenshot/XML prove the AHO→VCE card, Static/Live chooser, and Start & send action are above bottom navigation. These are product screenshots only; UI reviewer/screenshot-baseline verification remains explicitly deferred.
