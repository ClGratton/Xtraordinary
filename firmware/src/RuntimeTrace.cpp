...
const char* checkpointName(const uint16_t value) {
  switch (static_cast<Checkpoint>(value)) {
    ...
    case Checkpoint::COMPANION_PACKET_ENTER: return "COMPANION_PACKET_ENTER";
    case Checkpoint::COMPANION_LIBRARY_SCAN_ENTER: return "COMPANION_LIBRARY_SCAN_ENTER";
    case Checkpoint::COMPANION_LIBRARY_SCAN_EXIT: return "COMPANION_LIBRARY_SCAN_EXIT";
    case Checkpoint::COMPANION_PACKET_EXIT: return "COMPANION_PACKET_EXIT";
