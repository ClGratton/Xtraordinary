...
uint8_t HalGPIO::getRawButtonState() const { return inputMgr.getRawState(); }

uint8_t HalGPIO::getDebouncedButtonState() const { return inputMgr.getDebouncedState(); }

uint8_t HalGPIO::getPressedButtonEvents() const { return inputMgr.getPressedEvents(); }

uint8_t HalGPIO::getReleasedButtonEvents() const { return inputMgr.getReleasedEvents(); }
