...
class HalClock {
 ...
 public:
  ...
  // Read/write the complete battery-backed RTC value as UTC Unix time.
  bool getEpochSeconds(uint64_t& epochSeconds) const;
  bool setEpochSeconds(uint64_t epochSeconds);
